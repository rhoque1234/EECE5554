#!/usr/bin/env python3
"""
Analysis script for Lab 4 - Circle Walking Data
Generates Figures 1-8 as required by lab instructions
"""
...
class CircleWalkingAnalyzer:
    ...
    def plot_mag_calibration(self, output_dir):
        ...
        plt.suptitle('Figure 1: Magnetometer Calibration (Circle Walking)', fontsize=14, y=1.02)
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig1_mag_calibration.png'
    ...
    def plot_gyro_x(self, output_dir):
        ...
        plt.suptitle('Figure 2: Gyroscope X-axis Analysis', fontsize=14, y=0.995)
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig2_gyro_x.png'
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"Saved {output_file}")
        plt.close()
    ...
    def plot_gyro_y(self, output_dir):
        ...
        plt.suptitle('Figure 3: Gyroscope Y-axis Analysis', fontsize=14, y=0.995)
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig3_gyro_y.png'
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"Saved {output_file}")
        plt.close()
    ...
    def plot_gyro_z_and_heading(self, output_dir):
        ...
        plt.suptitle('Figure 4: Z-axis Rotation and Heading Analysis', fontsize=14, y=0.995)
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig4_gyro_z_heading.png'
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"Saved {output_file}")
        plt.close()
    ...
    def plot_accel_x(self, output_dir):
        """
        Figure 5: Accelerometer X - acceleration and integrated velocity
        """
        # Remove gravity component and integrate to get velocity
        # For X-axis (forward), gravity effect is minimal when level
        ...
        plt.suptitle('Figure 5: Accelerometer X-axis Analysis', fontsize=14, y=0.995)
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig5_accel_x.png'
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"Saved {output_file}")
        plt.close()
    ...
    def plot_accel_y(self, output_dir):
        """
        Figure 6: Accelerometer Y - acceleration and integrated velocity
        """
        ...
        plt.suptitle('Figure 6: Accelerometer Y-axis Analysis', fontsize=14, y=0.995)
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig6_accel_y.png'
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"Saved {output_file}")
        plt.close()
    ...
    def plot_accel_z(self, output_dir):
        """
        Figure 7: Accelerometer Z - acceleration and integrated velocity
        """
        ...
        plt.suptitle('Figure 7: Accelerometer Z-axis Analysis', fontsize=14, y=0.995)
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig7_accel_z.png'
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"Saved {output_file}")
        plt.close()
    ...
    def plot_trajectory(self, output_dir):
        ...
        plt.title('Figure 8: Estimated Trajectory (Circle Walking)')
        plt.grid(True, alpha=0.3)
        plt.axis('equal')
        plt.legend()
        plt.tight_layout()
        
        output_file = Path(output_dir) / 'fig8_trajectory.png'
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"Saved {output_file}")
        plt.close()
        
    def generate_all_plots(self, output_dir):
        """Generate all required plots for circle walking"""
        output_dir = Path(output_dir)
        output_dir.mkdir(parents=True, exist_ok=True)
        
        print("Generating plots for circle walking...")
        print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description='Analyze circle walking data for Lab 4')
    ...
    analyzer = CircleWalkingAnalyzer(args.data)
